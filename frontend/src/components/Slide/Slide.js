                  ...
                  <div className="carousel-inner">
                    <div className="carousel-item active">
                        <div className='logo animated zoomIn d-block w-100'>
                            <i className="ion ion-bug" alt="First slide"></i>
                            <i className='far fa-chart-bar'></i>
                        </div>
                      <div className='carousel-caption'>
                        <h5>Welcome to ZeroBug</h5>
                        <p>
                            The all-inclusive project management solution that travels along with you. Collaborate and track your projects on the go.
                        </p>
                      </div>
                    </div>
                    <div className="carousel-item">
                      <div className='logo d-block w-100'>
                            <i className="ion ion-bug bug-rotate" alt="Second slide"></i>
                      ...
                      <div className='carousel-caption'>
                        ...
                        <p>
                            Access your project feed, bugs even as you are away from your desk 
                        </p>
                      </div>
                    </div>
